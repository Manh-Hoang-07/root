  ...
  <Modal :model-value="true" title="Thêm dịch vụ mới" @update:model-value="$emit('close')">
    <form @submit.prevent="handleSubmit">
      ...
      <div class="mb-4">
        ...
        <select v-model="providerId" class="w-full px-4 py-2 border rounded-xl" required>
      ...
      <div class="mb-4">
        ...
        <select v-model="serviceStatus" class="w-full px-4 py-2 border rounded-xl" required>
