...
watch(() => props.show, (newValue) => {
  ...
  if (newValue) {
    ...
    brandData.value = null // Reset data khi đóng modal
    loading.value = false
  }
}, { immediate: true })
...
async function handleSubmit(formData) {
  try {
    ...
    await axios.post(endpoints.brands.update(props.brand.id), dataWithMethod)
    emit('updated')
    props.onClose()
  } catch (error) {
