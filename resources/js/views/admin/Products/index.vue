<template>
  ...
  <div>
          ...
          <tbody class="bg-white divide-y divide-gray-200">
            ...
            >
              ...
              <td class="px-6 py-4 whitespace-nowrap">
                ...
                <div v-if="product.original_price > product.price" class="text-sm text-gray-500 line-through">
                  {{ formatCurrency(product.original_price) }}
                </div>
              </td>
              <td class="px-6 py-4 whitespace-nowrap">
    ...
    >
      <div class="bg-white rounded-2xl shadow-2xl w-full max-w-2xl transform transition-all duration-300 max-h-[90vh] overflow-y-auto">
...
const products = ref([
  ...
  },
  {
    ...
    description: 'Galaxy S24 Ultra với S Pen tích hợp, camera 200MP, màn hình 6.8 inch Dynamic AMOLED 2X'
  },
  {
    id: 3,
    ...
    description: 'MacBook Pro 14 inch với chip M3 Pro, màn hình Liquid Retina XDR, RAM 18GB'
  },
  {
    id: 4,
  ...
  },
  {
    ...
    description: 'Xiaomi 14 Ultra với camera Leica, màn hình 6.73 inch AMOLED, chip Snapdragon 8 Gen 3'
  },
  {
    id: 6,
    ...
    description: 'AirPods Pro thế hệ 2 với chống ồn chủ động, âm thanh không gian, cổng USB-C'
  }
])
...
const saveProduct = () => {
  if (showEditModal.value) {
    ...
    const newProduct = {
      ...
      original_price: Number(productForm.value.original_price),
