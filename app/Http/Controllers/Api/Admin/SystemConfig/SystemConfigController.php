...
class SystemConfigController extends BaseController
{
    ...
    {
        try {
            $validator = app(SystemConfigRequest::class);
            $validated = $validator->validate();
            $data = $this->service->create($validated);
            
            return $this->successResponse(
                new SystemConfigResource($data),
                'Tạo cấu hình thành công'
            );
        } catch (\Exception $e) {
            $this->logError('Store', $e);
            return $this->errorResponse('Không thể tạo cấu hình');
        }
    }
    ...
    public function show($id, Request $request = null): JsonResponse
    {
        try {
            ...
            if (!$data) {
                return $this->errorResponse('Không tìm thấy cấu hình', 404);
            }
            ...
            return $this->errorResponse('Không thể tải thông tin cấu hình');
        }
    }
    ...
    public function update($id)
    {
        try {
            ...
            if (!$data) {
                return $this->errorResponse('Không tìm thấy cấu hình để cập nhật', 404);
            }
            ...
            return $this->errorResponse('Không thể cập nhật cấu hình');
        }
    }
    ...
    public function destroy($id): JsonResponse
    {
        try {
            ...
            return $this->errorResponse('Không thể xóa cấu hình');
        } catch (\Exception $e) {
