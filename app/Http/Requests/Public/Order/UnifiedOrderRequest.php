...
class UnifiedOrderRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        // For authenticated users, require cart_id
        if ($this->isAuthenticated()) {
            $rules['cart_id'] = ['required', 'string'];
        }
    ...
    public function messages(): array
    {
        ...
        if ($this->isAuthenticated()) {
            $messages['cart_id.required'] = 'Giỏ hàng là bắt buộc';
        } else {
