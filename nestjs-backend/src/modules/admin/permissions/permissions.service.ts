...
export class PermissionsService {
  ...
  // Permissions
  async list(filters: any = {}, perPage: number = 20, page: number = 1) {
    return this.listGeneric(this.permissionRepository, filters, perPage, page);
  }
  ...
  async create(createDto: any) {
    const permission = this.permissionRepository.create(createDto as any);
  ...
  async update(id: string, updateDto: any) {
    ...
    const updatedPermission = this.permissionRepository.merge(existingPermission, updateDto as any);
